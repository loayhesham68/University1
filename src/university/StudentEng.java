...
public class StudentEng {
    ...
    private String Departement;
      ...
      public StudentEng(int id,String name,double gpa){
        this.Id = id;
        this.Name = name;
        this.Gpa = gpa;
    }
    
    public StudentEng(String Subject1,String Subject2,String Subject3){
    ...
    public StudentEng(String Subject1,String Subject2,String Subject3,String Subject4){
        this.Subject1 = Subject1;
        this.Subject2 = Subject2;
        this.Subject3 = Subject3;
    ...
    public StudentEng(String Subject1,String Subject2,String Subject3,String Subject4,String Subject5){
        this.Subject1 = Subject1;
        this.Subject2 = Subject2;
        this.Subject3 = Subject3;
        this.Subject4 = Subject4;
    ...
    public StudentEng(String Subject1,String Subject2,String Subject3,String Subject4,String Subject5,String Subject6){
        this.Subject1 = Subject1;
        this.Subject2 = Subject2;
        this.Subject3 = Subject3;
        this.Subject4 = Subject4;
    ...
    public StudentEng(String Subject1,String Subject2,String Subject3,String Subject4,String Subject5,String Subject6,String Subject7){
        this.Subject1 = Subject1;
        this.Subject2 = Subject2;
        this.Subject3 = Subject3;
        this.Subject4 = Subject4;
